// lib/hike.js — cliente de la API de Hike: refresh del token (guardado en Neon) + descarga de ventas.
...
// Lee el refresh_token más reciente; si no hay, lo siembra desde la variable de entorno.
...
// Cambia el refresh_token por un access_token fresco. Si Hike devuelve un nuevo
// refresh_token (rotación), lo guarda; si no, conserva el actual.
...
// Descarga TODAS las ventas del rango (paginando).
